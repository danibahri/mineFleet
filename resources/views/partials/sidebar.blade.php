<flux:sidebar sticky collapsible class="border-r border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950">
    ...
    <flux:sidebar.nav>
        <flux:sidebar.item icon="squares-2x2" href="/dashboard">Dashboard</flux:sidebar.item>
        <flux:sidebar.item icon="truck" href="/vehicle-management">Vehicle Management</flux:sidebar.item>
        <flux:sidebar.item icon="calendar-days" badge="8" href="#">Vehicle Booking</flux:sidebar.item>
        <flux:sidebar.item icon="clipboard-document-check" badge="12" href="#">Approval Management
        </flux:sidebar.item>
